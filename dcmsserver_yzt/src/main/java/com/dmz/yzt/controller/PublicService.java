...
public class PublicService extends HttpServlet {
    private static final Logger logger = Logger.getLogger(PublicService.class);
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        try {
            ...
            HttpUtil.returnMsg(httpServletResponse, messageResponse);
